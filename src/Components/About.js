...
class About extends Component {
  render() {
    ...
    return (
      <>
        <div
          className='f3 shadow-5 tc w-100 mt3'
          color={this.style}
          id='about_back'
        >
                  ...
                  <Col>
                    <Fade left cascade duration={2000} className=''>
                      <div className='code left mt3 mb4 v-mid b fw6 f2 '>
                        <p className='f5'>
                          Hey there! I'm a Full Stack Web Developer and
                          Programming Enthusiast.
                        </p>
                        <p className='f5'>
                          Self-taught and always curious, I thrive on challenges
                        ...
                        >
                          <Tilt tilt={24}>Check Out My Resume</Tilt>
                        </Button>
                      </div>
                    </Fade>
                  </Col>
